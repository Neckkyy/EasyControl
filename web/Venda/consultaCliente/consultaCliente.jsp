<%-- 
    ...
    Created on : 30 de nov. de 2024, 15:45:29
...
<html>
    ...
    <body>
        ...
        <%
            ...
            clienteid.setIdcliente(Integer.parseInt(request.getParameter("idcliente")));
            
            listaprodvenda = pvdao.consultaProdutosVendidosPorCliente(clienteid);
            int registro = 0;
            out.println("<br>Vendas para o Cliente ID:" + clienteid.getIdcliente() + "<br>");
        %>
